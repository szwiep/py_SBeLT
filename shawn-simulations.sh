python3 model/parallel.py 2 model/parameters/param-sim1.yaml model/parameters/param-sim2.yaml
python3 model/parallel.py 2 model/parameters/param-sim3.yaml model/parameters/param-sim4.yaml
